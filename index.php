        ...
        <main class="l-main">
            <article class="p-visual">
                <div class="p-visual--main">
                    <h2 class="c-title--main c-font-color--white c-font-family--mplus1 c-font-weight--bold">
                        ダミーサイト
                    </h2>
                </div>
                <ul class="p-visual--sub">
                    <li>
                        <div class="p-visual--sub--takeOut">
                            <h2
                                class="c-title--sub c-font-color--ea c-font-family--robot c-font-weight--bold c-title--underline">
                                Take Out
                            </h2>
                            <div class="sub-section">
                                <dl class="p-visual--sub--sentence c-background-color--white">
                                    <dt
                                        class="c-title--sentence c-font-color--3c c-font-family--mplus1 c-font-weight--bold">
                                        Take OUT</dt>
                                    <dd
                                        class="c-text--sub c-font-weight--normal c-font-color--3c c-font-family--mplus1">
