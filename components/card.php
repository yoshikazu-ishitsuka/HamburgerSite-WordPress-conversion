<section class="p-visual__archive--card">
    <figure class="p-card__menu">
        <img src="<?php echo get_theme_file_uri(); ?>/images/common/img_02.png" alt="チーズバーガーの画像" class="p-card__menu--image">
    ...
    <figure class="p-card__menu">
        <img src="<?php echo get_theme_file_uri(); ?>/images/common/img_02.png" alt="ダブルチーズバーガーの画像" class="p-card__menu--image">
        <figcaption class="p-card__menu--caption c-background-color--card">
    ...
    <figure class="p-card__menu">
        <img src="<?php echo get_theme_file_uri(); ?>/images/common/img_02.png" alt="スペシャルチーズバーガーの画像" class="p-card__menu--image">
        <figcaption class="p-card__menu--caption c-background-color--card">
